...
//public class EmpLoginServiceImpl2 implements EmpLoginService {
//
...
//
//	@Override
//    @Transactional // ★ DB 업데이트이므로 트랜잭션 권장
//    public void updateEmployeeRole(String empId, String newRoleName) {
//        // 1. Mapper에 전달할 VO 객체를 생성합니다.
//        EmpLoginVO loginVO = new EmpLoginVO();
//        loginVO.setEmpId(empId);
//        loginVO.setComName(newRoleName); // ★ 업데이트할 새 권한 설정
//
//        // 2. EmpLoginMapper.xml의 'updateEmployeeRole' 쿼리를 호출합니다.
...
//	        } catch (Exception e) {
//	            // (이미 계정이 있는 경우 등 예외 처리 필요)
//	            System.err.println("empId 형식 오류: " + empId);
//	            continue; // 한 명 실패해도 계속 진행
//	        }
//	        
//	        // 2. ★ activateLogin에 roleName을 직접 전달
