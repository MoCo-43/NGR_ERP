...
public class MvcConfig implements WebMvcConfigurer {
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		...
		//registry.addViewController("/mypage/mypage").setViewName("main/mypage");
...
//		registry.addViewController("/sal/salList").setViewName("main/salList");
		...
		registry.addViewController("/accountclose").setViewName("account/close");
		...
		// 인사
		 ...
		 registry.addViewController("/paytransfer").setViewName("hr/PayTransfer");
	}
